...
<p>
    ...
    Ця активність переду&#x0084; є роботі сервлетів і може виконуватись
    до маршрутизації, тобто для всіх запитів (на всі адреси, довільним
    методом: БЕТ, POST, ...). Більш того, додаткові фільтри можуть
...
<p>
    ...
    для request та response. Ця процедура може бути здійснена ДО моменту
    першого читання/запису, оскільки підтримує мультибайт кодування
</p>
<ul class="collection">
